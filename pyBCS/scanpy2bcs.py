...
class DataObject(ABC):
    def __init__(self, source, root_name, output_name):
        self.source = source
    ...
    def write_metadata(self):
        ...
        with self.zobj.open(dest + "/main/metadata/metalist.json", "w") as z:
        ...
        for uid in content:
            ...
            with self.zobj.open(dest + ("/main/metadata/%s.json" % uid), "w") as z:
    ...
    def write_dimred(self):
        ...
        for dimred in dimred_data:
            ...
            with self.zobj.open(dest + "/main/dimred/" + coords["id"], "w") as z:
        ...
        with self.zobj.open(dest + "/main/dimred/meta", "w") as z:
